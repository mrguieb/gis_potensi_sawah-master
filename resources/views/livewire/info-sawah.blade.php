<div>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">{{ __('Land Information') }}</div>

                    <div class="card-body">
                        {{-- add button --}}
                        <div class="row">
                            <div class="col-md-12">
                                <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addModal">Add Data</a>
                            </div>
                        </div>
                        {{-- end add button --}}
                        <br>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addModalLabel">Add Land Information</h5>
                ...
                <div class="modal-body text-left">
                    <form wire:submit.prevent="store">
                        <div class="form-group row">
                            <label for="jenis_tanah" class="col-md-4 col-form-label text-md-right">{{ __('Soil Type') }}</label>
                            ...
                            {{-- ketinggian --}}
                            <label for="ketinggian_tanah" class="col-md-4 col-form-label text-md-right">{{ __('Ground Height/Elevation') }}</label>
                            <div class="col-md-6 mb-2">
                            ...
                            {{-- kelembaban --}}
                            <label for="kelembaban_tanah" class="col-md-4 col-form-label text-md-right">{{ __('Soil Moisture') }}</label>
                            <div class="col-md-6 mb-2">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" data-bs-dismiss="modal" @if($jenis_tanah=='' || $ketinggian_tanah=='' || $kelembaban_tanah=='' ) disabled @endif>Add</button>
                        </div>
                    </form>
                </div>
            </div>
